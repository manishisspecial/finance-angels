...
-- This will completely fix the advisor registration issue
-- Copy and paste this entire script into your Supabase SQL Editor and run it

-- STEP 1: First, let's check if the advisors table exists and drop it completely
...
-- STEP 2: Recreate the advisors table with EXACT structure matching the form
...
-- This is the most important policy - it allows ANYONE to register as an advisor
...
-- STEP 7: Create policies for service role (admin access)
CREATE POLICY "service_role_full_access" ON advisors
    FOR ALL 
    TO service_role
    USING (true);

-- STEP 8: Create policies for other tables
...
-- STEP 10: Test the setup with a test insertion
...
-- STEP 12: Verify all policies are created
SELECT 
    schemaname,
    tablename,
    policyname,
...
SELECT 'FINAL RLS FIX COMPLETED SUCCESSFULLY!' as status; 